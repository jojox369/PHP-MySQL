...
<body>
  ...
  ?>
    ...
    <span class="caracteres">50</span> Restantes <br>
            <input type="text" name="nome" id="nome" class="form-text" placeholder="Nome " onkeyup="maiuscula(this)" onkeypress="return ApenasLetras(event,this);" maxlength="50" autofocus><br>
            
            <span class="cnpj">18</span> Restantes <br>
            <input type="text" name="cnpj" id="cnpj" class="form-control" placeholder="CNPJ "> <br>
            ...
            <input type="submit"  value="Cadastrar" class="form-control btn btn-estilo"><br><br>
